...
if os.path.isfile(output_file):
    ...
    print(f"{Fore.RED}'proxy.txt' deleted successfully.{Fore.RESET}")

print(f"{Fore.YELLOW}Commencing Scraper\n")
    ...
    try:
        ...
        if response.status_code == 200:
            with open(output_file, 'a') as file:
                ...
                print(f"{Fore.GREEN}SNUFFED {Fore.WHITE}{url} {Fore.GREEN}")
        else:
            print(f"{Fore.RED}They Got AWAY... {url}{Fore.RESET}")
    except Exception as e:
        print(f"{Fore.RED}GADDAMN! {url}{Fore.RESET}")
...
def check(file, timeout, method, site, verbose, random_user_agent):
    ...
    print(f"{Fore.GREEN}Collected {Fore.YELLOW}{len(valid_proxies)} {Fore.GREEN}valid proxies")
...
print(f"\n{Fore.WHITE}( {Fore.YELLOW}{jumlh} {Fore.WHITE}) {Fore.GREEN}Proxies have been sucked, Do you wanna check them!? {Fore.WHITE}({Fore.GREEN}Y{Fore.WHITE}/{Fore.RED}N{Fore.WHITE}): ", end="")
...
if choice == 'y' or choice == 'Y':
    ...
    print(f"{Fore.YELLOW}Done, Aight now get lost...!.\n")
